...
local: upstreams/herdr
last_analyzed_commit: a0678a3
...
> Extracted from HEAD `a0678a3` on 2026-07-15. Clone: `upstreams/herdr`. Full inventory report: `docs/distillery/reports/distill-herdr-inventory-2026-07-15.md`.
...
- **Where:** `AGENTS.md` (Docs section: "Put local PRDs, planning notes, and exploratory specs under .local/prd/; .local/ is ignored and locally controlled." — the directory itself is gitignored, so it is not present at HEAD)
